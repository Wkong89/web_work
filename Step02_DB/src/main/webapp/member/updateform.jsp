   ...
   <div class="container">
      <nav class="mt-2">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">정보 수정 페이지</li>
         </ol>
      </nav>
      <h1>회원 정보 수정 폼</h1>
      <form action="update.jsp" method="post">
         <!-- 
            ...
            input type="hidden" 요소를 이용해서 
            회원의 번호가 폼을 제출했을때 전송되도록 한다.
          -->
         ...
         <button class="btn btn-primary btn-sm" type="submit">수정 확인</button>
